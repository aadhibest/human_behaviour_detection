...
out = cv2.VideoWriter('yolov3.avi', fourcc, 20.0, (640, 480))
...
while(True):
    ...
    elapse = time.time() - starting
    fps = frame_id / elapse
    cv2.putText(image, "FPS: " + str(round(fps, 2)), (10, 50), cv2.FONT_HERSHEY_PLAIN, 4, (0, 0, 0), 3)
    """
